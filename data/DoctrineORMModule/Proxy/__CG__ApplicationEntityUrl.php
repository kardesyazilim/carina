 ...
 */
class Url extends \Application\Entity\Url implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Url' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Url' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\Url' . "\0" . 'status', '' . "\0" . 'Application\\Entity\\Url' . "\0" . 'created_at', '' . "\0" . 'Application\\Entity\\Url' . "\0" . 'modified_at', 'inputFilter');
        }
