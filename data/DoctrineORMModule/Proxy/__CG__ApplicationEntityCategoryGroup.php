 ...
 */
class CategoryGroup extends \Application\Entity\CategoryGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\CategoryGroup' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\CategoryGroup' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\CategoryGroup' . "\0" . 'status', 'inputFilter');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CategoryGroup $proxy) {
